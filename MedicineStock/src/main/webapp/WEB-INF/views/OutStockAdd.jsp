...
<div>
    ...
    <button style="float: right" id="add-btn" class="btn btn-primary" onclick="addOutstock()" data-loading-text="Loading..."
            type="button">新增入库
    </button>
    ...
    <div class="jumbotron">
        <div class="container">
            <ul style="list-style: none">
                <li>出库订单:<input name="outstockno" type="text" class="form-control" style="display: inline-block;width: 130px" disabled value="CB201911190029"/></li>
                <li>出库备注:<input name="mark"  class="form-control" style="display: inline-block;width: 130px" type="text"/></li>
                <li>出库类型:<select name="typeid" class="form-control" style="display: inline-block;width: 130px">
            ...
            <ul style="list-style: none">
                <li>出库日期:<input name="outdate" type="date" class="form-control" style="display: inline-block;width: 130px"/></li>
    ...
    $(function () {
        ...
        $("#baocun").click(function () {
            ...
            $("input[name='check']:checked").each(function(i,em) {
                //alert($(em).parent().parent().html());
                //$(em).parent()
                //alert(elm.find("td:eq(2)").html());
                body+="<tr class='tr'>" +
                    ...
                    "<td>0</td>" +
                    "<td>0</td>" +
                    "<td><img onclick='remove(this)' style='width: 20px;height: 20px' src='../img/timg.jpg'/></td>" +
                    "</tr>";
            });
            $("#body1").prepend(body);
            $('#myModal').modal('hide');
